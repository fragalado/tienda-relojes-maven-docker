...
public class VerTablaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ProductoDto> productosDto = productoDao
                .obtenerTodosLosProductosDeUnUsuarioPorDNI(Integer.parseInt(session.getAttribute("idUsu").toString()));
