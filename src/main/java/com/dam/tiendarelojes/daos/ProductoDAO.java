...
public interface ProductoDAO {
    ...
    /**
     * Metodo que guarda un producto pasado por parámetros en una base de datos MySQL
     ...
     * @return Devuelve una lista con todos los productos o null si no existe ninguno
     */
