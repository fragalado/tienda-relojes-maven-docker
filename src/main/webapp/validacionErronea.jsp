...
<html lang="es">
    <head>
        ...
        <title>Error en la validacion</title>
        <!-- Bootstrap -->
    ...
    <body>
        ...
        <main class="container text-center mt-5">
            <h1 class="text-danger">⚠ ¡Error de Validación! ⚠</h1>
            <p class="lead">El identificador o la contraseña son incorrectos.</p>
            ...
            <div class="mt-4">
                <a href="index.jsp" class="btn btn-primary">Intentar de nuevo</a>
            </div>
        </main>
